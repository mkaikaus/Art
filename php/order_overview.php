    ...
    <div class="menu bg-light">
        <div class="container">
            <div class="row text-center info">
                ...
                <div class="col-sm">
                    <a href="" class="btn  btn-light">Order Overview</a>
                </div>
                <div class="col-sm">
                ...
                <div class="container">
                    ...
                    ?>
                        ...
                        <tr class="text-center container">
                            ...
                            if ($row2['flag'] == 0) {
                            ?>
                                <td><?php echo "Order processed" ?><i class='fas fa-pause-circle' style='color: teal'></i></td>
                            ...
                            if ($row2['flag'] == 0) {
                            ?>
                                <td><a href="order_overview.php?cancel=<?php echo $row2['OrderID']; ?>" class="btn btn-danger">Cancel Order</a></button></td>
